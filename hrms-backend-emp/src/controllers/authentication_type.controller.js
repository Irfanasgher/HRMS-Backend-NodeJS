...
exports.create = async (req, res) => {
  // Create comment
  const addressType = {
    name_authentication_type: req.body.name_authentication_type,
    setting_authentication_type: req.body.setting_authentication_type,
    is_sysadmin: req.body.is_sysadmin,

    is_enable: 1,
  };
  await db.authentication_type
    .create(addressType)
    .then((data) => {
      res.send(data);
    })
...
exports.findById = async (req, res) => {
  db.authentication_type
    .findOne({ where: { id_authentication_type: req.params.id, is_enable: 1 } })
    .then((data) => {
      res.send(data);
    })
    .catch((err) => {
...
exports.updateById = async (req, res) => {
  ...
  db.authentication_type
    .update(req.body, {
      where: { id_authentication_type: id },
    })
    .then((num) => {
      if (num == 1) {
        res.send({
